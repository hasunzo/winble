...
public interface InfluencerRepository extends JpaRepository<Influencer, Long> {
    ...
    Optional<Influencer> findByLoginIdAndSignUpType(String loginId, SignUpType signUpType);
    // 회원이 존재하는 지를 확인
    boolean existsByLoginIdAndSignUpType(String loginId, SignUpType signUpType);
}

...
import com.winble.server.adapter.config.security.handler.CustomAccessDeniedHandler;
import com.winble.server.adapter.config.security.handler.CustomAuthenticationEntryPoint;
        ...
        http
                ...
                .and()
                    .authorizeRequests() // 다음 리퀘스트에 대한 사용권한 체크
                        .antMatchers("/*/login","/*/login/*", "/*/join", "/*/join/*", "/").permitAll()  // 로그인, 회원가입 -> 누구나 접근 가능
